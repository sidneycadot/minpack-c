    ...
    )
{
    ...
    const doublereal p5    = 0.5;
    const doublereal p25   = 0.25;
    const doublereal p75   = 0.75;
    ...
    doublereal pnorm, xnorm = 0.0, fnorm1;
    ...
    while (1) // outer loop
    {
        ...
        *nfev += n;
        ...
        do {
            ...
            const doublereal prered = square(temp1) + square(temp2) / p5;

            const doublereal dirder = -(square(temp1) + square(temp2));
